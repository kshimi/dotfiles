...
DOTFILES_GITHUB="https://github.com/kshimi/dotfiles.git"; export DOTFILES_GITHUB
...
software_packages_install() {
    e_newline
    e_header "Installing software packages..."

    os_detect
    case "$PLATFORM" in
        *'linux'*)  bash -c "$(cat ${DOTPATH}/etc/linux_install.sh)" ;;
        *'darwin'*) e_header "installing darwin" ;;
        *'bsd'*)    e_header "installing bsd" ;;
        *)          e_header "unknown" ;;
    esac
